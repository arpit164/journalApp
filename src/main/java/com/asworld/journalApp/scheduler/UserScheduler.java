...
//                log.info("Mail sended to user:" + user.getUserName() + " Email:" + user.getEmail());
                ...
                SentimentData sentimentData = SentimentData.builder().email(user.getEmail()).sentiment("Sentiment for last 7 days of user:" + user.getUserName() , mostFrequentSentiment.toString()).build();
